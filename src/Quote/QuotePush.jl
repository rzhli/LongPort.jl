...
set_on_quote!(callbacks::Callbacks, callback) =
    (callbacks.realtime_quote = callback; callbacks)
...
set_on_candlestick!(callbacks::Callbacks, callback) =
    (callbacks.candlestick = callback; callbacks)
