...
export QuoteCommand,
    ...
    PrePostQuote,
    SecurityQuote,
    SecurityQuoteResponse,         # 结构体类型Struct
    SecurityStaticInfo,
    ...
    QuoteUnsubscribeRequest,                            # 结构体类型Struct
...
default_values(::Type{SecurityStaticInfo}) = (;
    symbol = "",
    name_cn = "",
    name_en = "",
    name_hk = "",
    ...
    bps = 0.0,
    dividend_yield = 0.0,
    stock_derivatives = Int64[],
    board = "",
)
field_numbers(::Type{SecurityStaticInfo}) = (;
    symbol = 1,
    name_cn = 2,
    name_en = 3,
    name_hk = 4,
...
default_values(::Type{SecurityStaticInfoResponse}) =
...
function show(io::IO, q::PrePostQuote)
    print(
        io,
        "{ last: $(q.last_done), high: $(q.high), low: $(q.low), volume: $(q.volume), turnover: $(q.turnover) }",
    )
end
...
default_values(::Type{Candlestick}) = (;
    close = 0.0,
    open = 0.0,
    low = 0.0,
    high = 0.0,
...
field_numbers(::Type{Candlestick}) = (;
    close = 1,
    open = 2,
    low = 3,
    high = 4,
...
field_numbers(::Type{SecurityCandlestickRequest}) =
    (; symbol = 1, period = 2, count = 3, adjust_type = 4, trade_session = 5)
...
function _encoded_size(x::SecurityCandlestickRequest)
    ...
    x.adjust_type != AdjustType.NO_ADJUST &&
        (encoded_size += _encoded_size(x.adjust_type, 4))
    x.trade_session != TradeSession.Intraday &&
        (encoded_size += _encoded_size(x.trade_session, 5))
    return encoded_size
end
...
default_values(::Type{OffsetQuery}) =
    (; direction = Direction.BACKWARD, date = "", minute = "", count = 0)
...
default_values(::Type{SecurityHistoryCandlestickRequest}) = (;
    symbol = "",
    period = CandlePeriod.UNKNOWN_PERIOD,
    adjust_type = AdjustType.NO_ADJUST,
    query_type = HistoryCandlestickQueryType.UNKNOWN_QUERY_TYPE,
    offset_request = nothing,
    date_request = nothing,
    trade_session = TradeSession.Intraday,
)
field_numbers(::Type{SecurityHistoryCandlestickRequest}) = (;
    symbol = 1,
    period = 2,
    adjust_type = 3,
    query_type = 4,
...
function encode(e::ProtoBuf.AbstractProtoEncoder, x::SecurityHistoryCandlestickRequest)
    ...
    x.query_type != HistoryCandlestickQueryType.UNKNOWN_QUERY_TYPE &&
        encode(e, 4, x.query_type)
...
function _encoded_size(x::SecurityHistoryCandlestickRequest)
    ...
    x.period != CandlePeriod.UNKNOWN_PERIOD && (encoded_size += _encoded_size(x.period, 2))
    x.adjust_type != AdjustType.NO_ADJUST &&
        (encoded_size += _encoded_size(x.adjust_type, 3))
    x.query_type != HistoryCandlestickQueryType.UNKNOWN_QUERY_TYPE &&
        (encoded_size += _encoded_size(x.query_type, 4))
    ...
    x.trade_session != TradeSession.Intraday &&
        (encoded_size += _encoded_size(x.trade_session, 7))
    return encoded_size
end
...
default_values(::Type{SecurityCandlestickResponse}) =
    (; symbol = "", candlesticks = Candlestick[])
...
default_values(::Type{QuoteSubscribeRequest}) =
    (; symbol = String[], sub_type = SubType.T[], is_first_push = false)
field_numbers(::Type{QuoteSubscribeRequest}) =
    (; symbol = 1, sub_type = 2, is_first_push = 3)
...
# 行情订阅响应（空消息）
struct QuoteSubscribeResponse end
...
default_values(::Type{QuoteUnsubscribeRequest}) =
    (; symbol = String[], sub_type = SubType.T[], unsub_all = false)
...
# 行情取消订阅响应（空消息）
struct QuoteUnsubscribeResponse end
...
struct SubscriptionRequest end
...
default_values(::Type{Depth}) =
    (; position = zero(Int64), price = 0.0, volume = zero(Int64), order_num = zero(Int64))
...
default_values(::Type{PushDepth}) =
    (; symbol = "", sequence = zero(Int64), ask = Depth[], bid = Depth[])
...
default_values(::Type{PushBrokers}) = (;
    symbol = "",
    sequence = zero(Int64),
    ask_brokers = Brokers[],
    bid_brokers = Brokers[],
)
field_numbers(::Type{PushBrokers}) =
    (; symbol = 1, sequence = 2, ask_brokers = 3, bid_brokers = 4)
...
default_values(::Type{Trade}) = (;
    price = 0.0,
    volume = zero(Int64),
    timestamp = zero(Int64),
    trade_type = TradeType.UnknownTradeType,
    direction = TradeDirection.Neutral,
    trade_session = TradeSession.Intraday,
)
field_numbers(::Type{Trade}) = (;
    price = 1,
    volume = 2,
    timestamp = 3,
    trade_type = 4,
...
default_values(::Type{OptionExtend}) = (;
    implied_volatility = "",
...
field_numbers(::Type{OptionExtend}) = (;
...
default_values(::Type{WarrantExtend}) = (;
...
field_numbers(::Type{WarrantExtend}) = (;
    implied_volatility = 1,
    expiry_date = 2,
    last_trade_date = 3,
    outstanding_ratio = 4,
    ...
    category = 7,
    strike_price = 8,
    upper_strike_price = 9,
    lower_strike_price = 10,
    call_price = 11,
    underlying_symbol = 12,
)
...
default_values(::Type{OptionQuote}) = (;
    symbol = "",
    last_done = "",
    prev_close = "",
    open = "",
    ...
    turnover = "",
    trade_status = TradeStatus.Normal,
    option_extend = OptionExtend("", 0, "", "", "", "", "", "", "", ""),
)
field_numbers(::Type{OptionQuote}) = (;
    symbol = 1,
    last_done = 2,
    prev_close = 3,
    open = 4,
...
default_values(::Type{WarrantQuote}) = (;
    symbol = "",
    last_done = 0.0,
    prev_close = 0.0,
    open = 0.0,
...
field_numbers(::Type{WarrantQuote}) = (;
    symbol = 1,
    last_done = 2,
    prev_close = 3,
    open = 4,
...
default_values(::Type{SecurityDepthResponse}) =
    (; symbol = "", ask = Depth[], bid = Depth[])
...
default_values(::Type{SecurityBrokersResponse}) =
    (; symbol = "", ask_brokers = Brokers[], bid_brokers = Brokers[])
field_numbers(::Type{SecurityBrokersResponse}) =
    (; symbol = 1, ask_brokers = 2, bid_brokers = 3)
...
default_values(::Type{ParticipantInfo}) = (;
    broker_ids = Int64[],
    participant_name_cn = "",
    participant_name_en = "",
    participant_name_hk = "",
)
field_numbers(::Type{ParticipantInfo}) = (;
    broker_ids = 1,
    participant_name_cn = 2,
    participant_name_en = 3,
    participant_name_hk = 4,
)
...
default_values(::Type{ParticipantBrokerIdsResponse}) =
...
field_numbers(::Type{Line}) =
    (; price = 1, timestamp = 2, volume = 3, turnover = 4, avg_price = 5)
...
default_values(::Type{SecurityIntradayRequest}) =
    (; symbol = "", trade_session = TradeSession.All)
...
function _encoded_size(x::SecurityIntradayRequest)
    encoded_size = 0
    !isempty(x.symbol) && (encoded_size += _encoded_size(x.symbol, 1))
    x.trade_session != TradeSession.All &&
        (encoded_size += _encoded_size(x.trade_session, 2))
    return encoded_size
end
...
default_values(::Type{OptionChainDateStrikeInfoRequest}) =
    (; symbol = "", expiry_date = Date(1970, 1, 1))
...
default_values(::Type{StrikePriceInfo}) =
    (; price = 0.0, call_symbol = "", put_symbol = "", standard = false)
field_numbers(::Type{StrikePriceInfo}) =
    (; price = 1, call_symbol = 2, put_symbol = 3, standard = 4)
...
default_values(::Type{OptionChainDateStrikeInfoResponse}) =
    (; strike_price_info = StrikePriceInfo[])
field_numbers(::Type{OptionChainDateStrikeInfoResponse}) = (; strike_price_info = 1)

function decode(
    d::ProtoBuf.AbstractProtoDecoder,
    ::Type{<:OptionChainDateStrikeInfoResponse},
)
    strike_price_info = StrikePriceInfo[]
    while !message_done(d)
        field_number, wire_type = decode_tag(d)
...
default_values(::Type{IssuerInfo}) =
    (; id = zero(Int64), name_cn = "", name_en = "", name_hk = "")
...
default_values(::Type{FilterConfig}) = (;
    sort_by = WarrantSortBy.LastDone,
    sort_order = SortOrderType.Ascending,
    sort_offset = zero(Int64),
    sort_count = zero(Int64),
    type = WarrantType.T[],
    issuer = Int64[],
    expiry_date = FilterWarrantExpiryDate.T[],
    price_type = FilterWarrantInOutBoundsType.T[],
    status = WarrantStatus.T[],
)
field_numbers(::Type{FilterConfig}) = (;
    sort_by = 1,
    sort_order = 2,
    sort_offset = 3,
    sort_count = 4,
...
default_values(::Type{WarrantFilterListRequest}) = (;
    symbol = "",
    filter_config = FilterConfig(
...
field_numbers(::Type{WarrantFilterListRequest}) =
    (; symbol = 1, filter_config = 2, language = 3)
...
default_values(::Type{FilterWarrant}) = (;
    symbol = "",
    name = "",
    last_done = 0.0,
    change_rate = 0.0,
...
field_numbers(::Type{FilterWarrant}) = (;
    symbol = 1,
    name = 2,
    last_done = 3,
    change_rate = 4,
    ...
    expiry_date = 8,
    strike_price = 9,
    upper_strike_price = 10,
    lower_strike_price = 11,
    outstanding_qty = 12,
    outstanding_ratio = 13,
    premium = 14,
    itm_otm = 15,
    implied_volatility = 16,
    delta = 17,
    call_price = 18,
    to_call_price = 19,
...
default_values(::Type{WarrantFilterListResponse}) =
    (; warrant_list = FilterWarrant[], total_count = zero(Int64))
...
default_values(::Type{TradePeriod}) =
    (; beg_time = Int64(0), end_time = Int64(0), trade_session = TradeSession.Intraday)
...
default_values(::Type{MarketTradePeriodResponse}) =
...
default_values(::Type{MarketTradeDayRequest}) =
    (; market = "", beg_day = Date(1970, 1, 1), end_day = Date(1970, 1, 1))
...
default_values(::Type{MarketTradeDayResponse}) =
    (; trade_day = Date[], half_trade_day = Date[])
...
default_values(::Type{CapitalFlowIntradayResponse}) =
    (; symbol = "", capital_flow_lines = CapitalFlowLine[])
...
default_values(::Type{CapitalDistributionResponse}) = (;
    symbol = "",
    timestamp = 0,
    capital_in = CapitalDistribution(0.0, 0.0, 0.0),
    capital_out = CapitalDistribution(0.0, 0.0, 0.0),
)
field_numbers(::Type{CapitalDistributionResponse}) =
    (; symbol = 1, timestamp = 2, capital_in = 3, capital_out = 4)
...
default_values(::Type{SecurityCalcQuoteRequest}) =
    (; symbols = String[], calc_index = CalcIndex.T[])
...
default_values(::Type{SecurityCalcQuoteResponse}) =
...
default_values(::Type{MarketTemperatureResponse}) = (;
    temperature = nothing,
    description = "",
    valuation = nothing,
    sentiment = nothing,
...
field_numbers(::Type{MarketTemperatureResponse}) =
    (; temperature = 1, description = 2, valuation = 3, sentiment = 4, updated_at = 5)
...
default_values(::Type{MarketTemperature}) =
    (; timestamp = 0, temperature = 0, valuation = 0, sentiment = 0)
field_numbers(::Type{MarketTemperature}) =
    (; timestamp = 1, temperature = 2, valuation = 3, sentiment = 4)
...
default_values(::Type{HistoryMarketTemperatureResponse}) =
    (; list = MarketTemperature[], type = "")
field_numbers(::Type{HistoryMarketTemperatureResponse}) = (; list = 1, type = 2)

function decode(
    d::ProtoBuf.AbstractProtoDecoder,
    ::Type{<:HistoryMarketTemperatureResponse},
)
